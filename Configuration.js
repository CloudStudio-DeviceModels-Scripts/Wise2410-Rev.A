...
function getEndpoints(deviceAddress, endpoints) {
    ...
    var e = endpoints.addEndpoint("1", "X-Axis", endpointType.genericSensor);
    e.variableTypeId = 1361;
    var e = endpoints.addEndpoint("2", "Y-Axis", endpointType.genericSensor);
    e.variableTypeId = 1361;
    var e = endpoints.addEndpoint("3", "Z-Axis", endpointType.genericSensor);
    e.variableTypeId = 1361;
